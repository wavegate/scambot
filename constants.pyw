...
LEAGUES = ['Bestiary', 'Hardcore Bestiary', 'Standard', 'Hardcore']

GROUPS = ['any', 'ring', 'chest', 'gloves', 'dagger']

BASES = ['any', 'Gold Ring', 'Sapphire Ring', 'Diamond Ring', 'Platinum Kris', 'Steel Ring', 'Opal Ring']

CORRUPTEDS = ['Either', 'True', 'False']
